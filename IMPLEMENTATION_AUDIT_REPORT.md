...
> **Reason:** Pre-Debt Buster (Feb 2026). Does not include analytics/debt buster features. Superseded by `SYSTEM_TRUTH_REPORT.md` (2026-03-25).
...
| **6. Hunter Job Management** | 🟢 Complete | `Lines 1140+` | `hunter/screens/job_list_screen.dart` | Fully built with 700+ lines. Integrates intake form, processing stages, completion/invoicing, and service configuration. |
...
| **9. Bookkeeping & Financial** | 🟢 Complete | `Lines 1745+` | `bookkeeping/screens/invoice_list_screen.dart` | Fully built with 500+ lines. Includes Invoice management, Chart of Accounts, auto-calculated P&L statement, VAT reports, and PTY Ltd Equipment forms. |
...
| `hunter_services` / `job` tables | 🟢 Verified | Hunter Jobs | Hooked into the new job list and intake forms successfully. |
