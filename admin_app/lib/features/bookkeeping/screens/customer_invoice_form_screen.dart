...
class CustomerInvoiceFormScreen extends StatefulWidget {
  ...
  const CustomerInvoiceFormScreen({super.key, this.invoice, this.initialAccountId});

  @override
  State<CustomerInvoiceFormScreen> createState() => _CustomerInvoiceFormScreenState();
}
...
class _CustomerInvoiceFormScreenState extends State<CustomerInvoiceFormScreen> {
  ...
  Future<void> _loadInitial() async {
    ...
    try {
      ...
      if (widget.invoice != null) {
        ...
        _selectedAccountId = inv.accountId ?? widget.initialAccountId;
  ...
  Future<void> _confirmCancelInvoice(CustomerInvoice invoice) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.invoice != null ? 'Edit customer invoice' : 'New customer invoice'),
        backgroundColor: AppColors.primary,
        foregroundColor: Colors.white,
        actions: [
          if (widget.invoice != null && widget.invoice!.status == CustomerInvoiceStatus.draft)
            IconButton(
